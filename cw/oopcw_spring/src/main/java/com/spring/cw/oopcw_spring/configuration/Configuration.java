...
/**
 * The Configuration class manages the settings for the ticketing system,
 * allowing configuration of total tickets, ticket release rate, customer retrieval rate,
...
public class Configuration {
    ...
    public void saveToJson(String filepath) {
        ...
        try (FileWriter writer = new FileWriter(filepath)) {
            gson.toJson(this, writer); // Correct method name and serializing the object
